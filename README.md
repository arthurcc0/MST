...
Run Script: [scripts/train/main_train.py](scripts/train/main_train.py)
* Eg. `python scripts/train/main_train.py --dataset LIDC --model_name ResNet`
* Use `--model_name` to select:
    * ResNet = 3D ResNet50, 
    * ResNetSliceTrans = MST-ResNet, 
    * DinoV2ClassifierSlice = MST-DINOv2  

## Step 2: Predict & Evaluate Performance
Run Script: [scripts/predict/main_predict.py](scripts/predict/main_predict.py)
* Eg. `python scripts/predict/main_predict.py --run_folder LIDC/ResNet`
